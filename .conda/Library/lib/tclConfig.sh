...
# installed.
TCL_PREFIX='d:/Anaconda/Project/Sales Data Analysis Dashboard Project/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='d:/Anaconda/Project/Sales Data Analysis Dashboard Project/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='d:/Anaconda/Project/Sales Data Analysis Dashboard Project/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Id:/Anaconda/Project/Sales Data Analysis Dashboard Project/.conda\Library\include'
...
TCL_PACKAGE_PATH='d:/Anaconda/Project/Sales Data Analysis Dashboard Project/.conda\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Ld:/Anaconda/Project/Sales Data Analysis Dashboard Project/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='d:/Anaconda/Project/Sales Data Analysis Dashboard Project/.conda\Library\lib\tclstub86.lib'
